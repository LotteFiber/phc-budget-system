    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          <Link href={`/${locale}/dashboard/divisions`}>
      ...
      <div className="grid gap-6 grid-cols-1 lg:grid-cols-3">
        <Card>
          ...
          <CardContent>
            <p className="text-3xl font-bold">{division._count.users}</p>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-3xl font-bold">{division._count.budgets}</p>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-3xl font-bold">{division._count.expenses}</p>
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            {t("divisions.title")} {t("common.details")}
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <p className="font-medium">{division.nameLocal}</p>
            </div>
          </div>
